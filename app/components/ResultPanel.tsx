            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-0">
                ...
                <div className="p-4 space-y-0">
                    ...
                    <div className="relative pl-8 pb-6 border-l-2 border-gray-100 last:border-0 ml-3">
                        ...
                        <div className="bg-white border border-[var(--border)] rounded-xl p-3 shadow-sm hover:shadow-md transition-all">
                        ...
                        return (
                            <React.Fragment key={idx}>
                                ...
                                <div id={`place-card-${idx}`} className="relative pl-8 pb-6 border-l-2 border-gray-100 last:border-0 last:pb-0 ml-3">
                                    ...
                                    <div className={`bg-white border border-[var(--border)] rounded-xl p-3 shadow-sm hover:shadow-md transition-all group ${activeLegIndex === idx ? 'ring-2 ring-[var(--primary)]' : ''}`}>
